...
# Productos
p = CS_WEB_CRUD_Entidad(
        appFlask=app, objDB=mysql, entidad="Producto", esEL=True, tabla="productos", PKs="id",
        columnas=("descripcion", "fotoBase64"), orderBy="productos.descripcion",
...
e = CS_WEB_CRUD_Entidad(
        ...
        columnas="presentacion", orderBy="presentacion",
        objFKs=CS_DB_CRUD_Entidad2_FK(
                    tabla="envases", colFK="id_producto", tablaFK="productos", descripcionFK="descripcion",
                    whereJoinFK="envases.id_producto = productos.id", objFK=p), 
...
t = CS_WEB_CRUD_Entidad(
        ...
        objFKs=CS_DB_CRUD_Entidad2_FK(
                    tabla="stock", colFK="id_envase", tablaFK="envases", descripcionFK="presentacion",
                    whereJoinFK="stock.id_envase = envases.id", objFK=e),
