...
# t = CS_WEB_CRUD_Entidad(appFlask=None, objDB=None, entidad="Stock", esEL=True,
                        # tabla="stock", PKs="id",
                        # columnas=("fecha_vencimiento", "fecha_compra", "fecha_uso"),
                        # orderBy="id_envase, fecha_vencimiento",
                        # objFKs=CS_DB_CRUD_Entidad2_FK(tabla="stock", colFK="id_envase", 
                        #                 tablaFK="envases", descripcionFK="presentacion",
                        #                 whereJoinFK="stock.id_envase = envases.id", objFK=None),
