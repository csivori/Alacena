...
class CS_CRUD_Entidad2():
  """El objeto CS_CRUD_Entidad2 implementa una serie de métodos para facilitar la construcción de un CRUD Básico. Soporta automáticamente las siguientes operaciones:
    - 
...
############################################
  ...
  def getLastErrorMsg(self)->tuple:
    ...
    if err[1] == 1045:
      msgCausa = f"Acceso a la DB Denegado para este Usuario y Contraseña ({self.objDB.getDBUser()}/)."
